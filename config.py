...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1953343776:AAF2tbhzeaqoQiGVv2bHjFXpDbjQVtLS_ww' # Get it from https://t.me/BotFather
    APP_ID = '7314679' # Get it from my.telegram.org/apps
    API_HASH = '02c9e9470e7601d3673e54bc8269e618' # Get it from my.telegram.org/apps
